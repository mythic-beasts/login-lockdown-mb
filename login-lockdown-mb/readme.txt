=== Login LockDown ===
Developer: Michael VanDeMar (michael@endlesspoetry.com), Paul Warren (pdw@mythic-beasts.com)
Tags: security, login
...
IPv4 addresses are locked based on failed attempts from a class C network
(/24).  IPv6 addressed are locked based on failed attempts from a /64.
